...
?>
<section class="vh-100 w-100 gradient-custom-2 order-details-section" style="display: block;">
                    ...
                    <div class="card-header p-4">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <p class="text-muted mb-0"> Place On <span class="fw-bold text-body"><?php echo $row['date']; ?></span> </p>
                            </div>
                            <div>

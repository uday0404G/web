                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-9">
                                            ...
                                            <div class="rounded position-relative fruite-item" style="">
                                                ...
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    ...
                                                    <div class="d-flex justify-content-between flex-lg-wrap">
                                                        ...
                                                        <a href="#" class="btn border  aa rounded-pill px-3 "
                                ...
                                ?>
                                        ...
                                        <li class="page-item" > <a href="pagination3.php" class="rounded page-link">&laquo;</a></li>                
                                        ...
                                        <li class="page-item"><a href="pagination4.php" class="rounded active page-item">5</a></li>
                                        <li class="page-item"><a href="pagination.php" class="rounded page-item">6</a></li>
                                        <li class="page-item"><a href="pagination.php" class="rounded page-item">&raquo;</a></li>
                                        </div>
                                    </div>
                                    </div>
                                </div>

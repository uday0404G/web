                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-9">
                                ...
                                ?>
                                        ...
                                        <li class="page-item" > <a href="pagination4.php" class="rounded page-link">&laquo;</a></li>                
                                        ...
                                        <li class="page-item"><a href="pagination.php" class="rounded active page-item">6</a></li>
                                        <li class="page-item"><a href="shop.php" class="rounded page-item">&raquo;</a></li>
                                        </div>

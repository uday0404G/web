                            ...
                            <div class="row g-4 justify-content-center">
                                ...
                                <div class="col-12 ">
                                    <div class="pagination d-flex justify-content-center mt-5">
                                        <li class="page-item"> <a href="pagination.php"
                                                class="rounded page-link">&laquo;</a></li>
                                        <li class="page-item"><a href="shop.php.php"
                                                class=" rounded active page-item">1</a></li>
                                        <li class="page-item"><a href="pagination1.php" class="rounded page-item">2</a>
                                        </li>
                                        <li class="page-item"><a href="pagination2.php" class="rounded page-item">3</a>
                                        </li>
                                        <li class="page-item"><a href="pagination3.php" class="rounded page-item">4</a>
                                        </li>
                                        <li class="page-item"><a href="pagination4.php" class="rounded page-item">5</a>
                                        </li>
                                        <li class="page-item"><a href="pagination.php" class="rounded page-item">6</a>
                                        </li>
                                        <li class="page-item"><a href="pagination1.php"
                                                class="rounded page-item">&raquo;</a></li>

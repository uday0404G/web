                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-9">
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-4 aaa ">
                                            <div class="rounded position-relative fruite-item " style=" border: 1px solid #FFB524;">
                                ...
                                ?>
                                        ...
                                        <li class="page-item" > <a href="shop.php" class="rounded page-link">&laquo;</a></li>                
                                        <li class="page-item" ><a href="shop.php" class=" rounded  page-item">1</a></li>
                                        <li class="page-item" ><a href="pagination1.php" class="rounded active page-item">2</a></li>
                                        <li class="page-item" ><a href="pagination2.php" class="rounded  page-item">3</a></li>
                                        ...
                                        <li class="page-item"><a href="pagination2.php" class="rounded page-item">&raquo;</a></li>
                                        </div>

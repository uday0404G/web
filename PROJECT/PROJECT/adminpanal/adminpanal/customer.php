...
<a href="customer.php" class="activ" >
  <span class="material-symbols-outlined" >
 person_outline</span>
 <h3>Customer</h3>
     </a>
...
?>
          ...
          <td class="counter"><?php echo $row['id']?></td>
            <td class="warning"><?php echo $row['name']." ".$row['lname']?></td>
            <td class=""><?php echo $row['email']?></td>
            <td class="warning counter"><?php echo $row['phone']?></td>
            <td class="warning"><?php echo $row['gen']?></td>
            <td class="warning"><?php echo $row['city']?></td>
            <td class="warning counter"><?php echo $row['pincode']?></td>
            <td class="warning"><?php echo $row['country']?></td>
